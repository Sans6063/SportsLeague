    ...
    public class MatchController : ControllerBase
    {
            ...
            int tournamentId)
        {
            try
            {
                ...
                return Ok(this.mapper.Map<IEnumerable<MatchResponseDTO>>(matches));
        ...
        public async Task<ActionResult<MatchResponseDTO>> GetById(int id)
        {
            ...
            if (match == null)
                return NotFound(new { mesagge = $"Partido con ID {id} no encontrado" });
            return Ok(this.mapper.Map<MatchResponseDTO>(match));
        }
