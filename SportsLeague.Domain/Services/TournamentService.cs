...
namespace SportsLeague.Domain.Services
{
    public class TournamentService : ITournamentService
    {
        ...
        public async Task<Tournament?> GetByIdAsync(int id)
        {
            ...
            var tournamnet = await _tournamentRepository.GetByIdWithTeamAsync(id);
            if (tournamnet == null)
        ...
        public async Task UpdateAsync(int id, Tournament tournament)
        {
            ...
            if (existing == null)
                throw new KeyNotFoundException($"No se encontro el torneo con ID {id}");
        ...
        public async Task RegisterTeamAsync(int tournamentId, int teamId)
        {
            ...
            if (tournament == null)
                throw new KeyNotFoundException(
                    $"No se encontro el torneo con ID {tournamentId}");
            ...
            if (!teamExists)
                throw new KeyNotFoundException(
                    $"No se encontro el equipo con ID {teamId}");
            ...
            {
                throw new InvalidOperationException(
                    "Este equipo ya esta inscrito en el torneo");
            }
